...
def get_sample_lst():
    mrc_pre = open('/home/LAB/liqian/test/game/ccks-2020-finance-transfer-ee-baseline-master/pretrained_model/Bert-wwm-ext/predictions_test.json',encoding='utf-8')
    out_data = json.load(mrc_pre)
    mrc_test = open('/home/LAB/liqian/test/game/ccks-2020-finance-transfer-ee-baseline-master/CCKS-Mrc/data/test_test.json', "r", encoding="utf-8")
    lst = []
...
def merge_type_lst():
    sub_data = open('submission_SubAll_test.json','w',encoding='utf-8')
    sample_lst = get_sample_lst()
    official_test_df = open('/home/LAB/liqian/test/game/ccks-2020-finance-transfer-ee-baseline-master/dataset/test_test.json','r',encoding='utf-8')
    merge_lst = []
