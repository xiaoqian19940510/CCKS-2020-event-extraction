...
from preprocessing.data_processor1 import read_squad_data, read_qa_examples, convert_examples_to_features
...
def make_predict(model, tokenizer, data_dir):
    ...
    eval_examples = read_qa_examples(data_dir, corpus_type="test1")
