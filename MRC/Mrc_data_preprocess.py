...
def change_data():
    in_file = open('/home/LAB/liqian/test/game/Ori/dataset/train_base.json','r')
    final_lst = []
    for line in in_file:
        line = line.strip()
...
def get_torch_mrc_all_train_data():
    final_lst = change_data()
    out_file = open('/home/LAB/liqian/test/game/Ori/CCKS-Mrc/data/squad-like_all_train_data.json','w')
    lst = []
    dic1 = {}
    dic2 = {}
...
def get_mrc_test_data():
    ...
    cls_out = pd.read_csv('/home/LAB/liqian/test/game/Ori/CCKS-Cls/test_output/cls_out.csv')
    test_data = pd.read_csv('/home/LAB/liqian/test/game/Ori/CCKS-Cls/pybert/dataset/test.csv')
