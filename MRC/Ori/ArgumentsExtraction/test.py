...
if __name__ == "__main__":
    read_squad_data("/home/LAB/liqian/test/game/Ori/CCKS-Mrc/data/squad_like_test.json", "/home/LAB/liqian/test/game/Ori/CCKS-Mrc/data/",is_training=False)
    # examples = read_qa_examples("/home/LAB/liqian/test/game/ccks-2020-finance-transfer-ee-baseline-master/CCKS-Mrc/data/", "test")
    examples = read_qa_examples("/home/LAB/liqian/test/game/Ori/CCKS-Mrc/data/", "test")
    main('/home/LAB/liqian/test/game/Ori/CCKS-Mrc/data/')
