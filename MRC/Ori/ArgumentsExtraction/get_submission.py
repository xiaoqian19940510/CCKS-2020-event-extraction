...
def get_sample_lst():
    mrc_pre = open('/home/LAB/liqian/test/game/Ori/pretrained_model/Bert-wwm-ext/predictions.json',encoding='utf-8')
    out_data = json.load(mrc_pre)
    mrc_test = open('/home/LAB/liqian/test/game/Ori/CCKS-Mrc/data/test.json', "r", encoding="utf-8")
    lst = []
...
def merge_type_lst():
    sub_data = open('submission_SubAll_Ori.json','w',encoding='utf-8')
    sample_lst = get_sample_lst()
    official_test_df = open('/home/LAB/liqian/test/game/Ori/dataset/dev_base.json','r',encoding='utf-8')
    merge_lst = []
